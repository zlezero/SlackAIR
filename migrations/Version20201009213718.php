 ...
 */
final class Version20201009213718 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD departement_id_id INT DEFAULT NULL, ADD roles JSON NOT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649EAE6F2D2 FOREIGN KEY (departement_id_id) REFERENCES departement (id)');
        $this->addSql('CREATE INDEX IDX_8D93D649EAE6F2D2 ON user (departement_id_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649EAE6F2D2 ON user');
        $this->addSql('ALTER TABLE user DROP departement_id_id, DROP roles');
    }
}
